      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?php echo is_menu('pelanggan');?>">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php echo is_menu('pelanggan','limit');?>"><a href="<?php echo site_url('pelanggan/limit');?>"><i class="fa fa-money" aria-hidden="true"></i> <span>Tambah Limit</span></a></li>
          </ul>
        </li>
        ...
        <li class="treeview <?php echo is_menu('penjualan');?>">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php echo is_menu('penjualan','create');?>"><a href="<?php echo site_url('penjualan/create');?>" target="_blank"><i class="fa fa-plus-square-o" aria-hidden="true"></i> <span>Add Penjualan</span></a></li>
          </ul>
        </li>
