              ...
              <div class="box-body">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="<?php echo !empty($pelanggan) ? $pelanggan['id'] : $code_pelanggan;?>" id="kode" class="form-control" />
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label" for="phone">Limit</label>
                    <div class="col-sm-8">
                      <input type="text" value="<?php echo !empty($pelanggan) ? $pelanggan['limit'] : '';?>" name="limit" placeholder="7000" id="limit" disabled class="form-control" />
                    </div>
                  </div>
                </div>
              </div>
